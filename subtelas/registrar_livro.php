...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bindParam(':foto', $foto);
        ...
        if ($stmt->execute()) {
            ...
            if ($quantidade < 5) {
                $alerta_estoque = "⚠️ ALERTA: O livro '{$titulo}' foi cadastrado com estoque baixo ({$quantidade} exemplar(es)). Considere adquirir mais exemplares.";
            }
        } else {
                            ...
                            <div class="input-group" style="flex: 2.0;">
                                ...
                                <div class="input-wrapper">
                                   <!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                    ...
                                    <input type="number" id="quantidade" name="quantidade" required placeholder="Digite a quantidade do livro" min="1" oninput="validarQuantidade(this)">
                                </div>
                            </div>
