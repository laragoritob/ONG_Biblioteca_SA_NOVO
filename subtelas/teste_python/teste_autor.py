...
autor_input = driver.find_element(By.ID, "nome_autor")
autor_input.clear()
autor_input.send_keys("Emanuel da Silva")
time.sleep(2)

# Preenche o campo id do telefone
telefone_input = driver.find_element(By.ID, "telefone")
telefone_input.clear()
telefone_input.send_keys("47980272327")
time.sleep(2)

# Preenche o campo id do telefone
email_input = driver.find_element(By.ID, "email")
email_input.clear()
email_input.send_keys("emanuelsilva@gmail.com")
time.sleep(2)
