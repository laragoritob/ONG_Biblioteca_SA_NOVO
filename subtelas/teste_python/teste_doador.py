...
driver.get("http://localhost:8080/ONG_Biblioteca_SA_NOVO/subtelas/registrar_doador.php")

time.sleep(1)

# Preenche o campo Id do doador
doador_input = driver.find_element(By.ID, "nome_doador")
doador_input.clear()
doador_input.send_keys("Carlisle Cullen")
time.sleep(2)

# Preenche o campo id do telefone
telefone_input = driver.find_element(By.ID, "telefone")
telefone_input.clear()
telefone_input.send_keys("47981406912")
time.sleep(2)

# Preenche o campo id do telefone
email_input = driver.find_element(By.ID, "email")
email_input.clear()
email_input.send_keys("carlislecullen@gmail.com")
time.sleep(2)
