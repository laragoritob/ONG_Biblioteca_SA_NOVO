...
<!-- Botões de Navegação por Tabela -->
        ...
        <?php else: ?>
            ...
            <!-- Logs agrupados por tabela (apenas as permitidas para recreador) -->
            <?php 
            // Filtrar apenas as tabelas que o recreador pode ver
            $tabelas_permitidas_recreador = ['cliente', 'livro', 'emprestimo'];
            $logs_filtrados = array_intersect_key($logs_por_tabela, array_flip($tabelas_permitidas_recreador));
            ?>
    ...
    function baixarPDF() {
        ...
        const opt = {
            margin: 1,
            filename: 'relatorio_recreador.pdf',
