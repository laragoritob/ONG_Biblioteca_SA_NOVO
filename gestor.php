...
<!-- Botões de Navegação por Tabela -->
        ...
        <?php else: ?>
            ...
            <!-- Logs agrupados por tabela (apenas as permitidas para gestor) -->
            <?php 
            // Filtrar apenas as tabelas que o gestor pode ver
            $tabelas_permitidas_gestor = ['funcionario', 'doador'];
            $logs_filtrados = array_intersect_key($logs_por_tabela, array_flip($tabelas_permitidas_gestor));
            ?>
